...
public class Verify_Scroll_Up_without_Arrow_button_and_Scroll_Down_functionality_TC_026 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Verify that page is scrolled up and 'Full-Fledged practice Web site for Automation Engineers' text is visible on screen
		if (sp.verifyfullfledgedtext()) {
			System.out.println(
					"Verified that page is scrolled up and 'Full-Fledged practice website for Automation Engineers' text is visible on screen");
		} else {
			System.out.println(
					"Failed because that page is scrolled up and 'Full-Fledged practice website for Automation Engineers' text is not visible on screen");
		}
